...
const advantages = [
  ...
  },
  {
    ...
    image: "/images/ev-charge/bridz.png",
  },
  {
    ...
    image: "/images/ev-charge/enery-storage.png",
  },
]
  ...
  return (
    <section className="py-16 px-4 max-w-7xl mx-auto">
      ...
      <div className="text-center mb-12">
        <h2 className="text-4xl font-bold text-gray-900 mb-2">Top 5 Advantages</h2>
      </div>
            ...
            {advantages.map((_, index) => (
              <button
                ...
                className={`w-2 h-2 rounded-full transition-all duration-300 ${
                  activeAdvantage === index ? "bg-blue-500 w-8" : "bg-gray-300 hover:bg-gray-400"
                }`}
                onMouseEnter={() => setActiveAdvantage(index)}
