  ...
  return (
    ...
    <div className="mx-auto max-w-7xl px-4 md:px-8">
      <h2 className="text-4xl md:text-5xl font-semibold text-black mb-2">
        The latest. <span className="text-gray-600">Take a look at what's new, right now.</span>
      </h2>
    </div>
            ...
            <div className="p-5 md:p-6">
              ...
              <p
                className={cn(
                  ...
                  card.tone === "dark" ? "text-zinc-300" : "text-zinc-600",
                )}
              >
                {card.subtitle}
              </p>
              <p
                className={cn(
                  ...
                  card.tone === "dark" ? "text-zinc-400" : "text-zinc-500",
                )}
              >
                {card.price}
              </p>
